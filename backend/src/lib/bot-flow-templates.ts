  ...
  forms: [
    {
      ...
      fields: [
        ...
        },
        {
          id: "need",
          label: {
            uz: "Qanday mahsulot uchun yechim kerak? Turi, profili (ta'm/hid) va maxsus talablarni qisqacha yozing.\n\n<i>Masalan: gazlangan ichimlik, mango profili, shakarsiz, eksport talablari.</i>",
            ru: "Для какого продукта нужно решение? Кратко укажите тип, профиль (вкус/аромат) и особые требования.\n\n<i>Например: газированный напиток, профиль манго, без сахара, экспортные требования.</i>",
          },
          type: "text",
          required: true,
          options: [],
    ...
    },
    {
      ...
      fields: [
        ...
        { id: "city", label: { uz: "Shahar:", ru: "Город:" }, type: "text", required: true, options: [], mapTo: "location" },
        {
          id: "product",
          label: {
            uz: "Qaysi mahsulot/soha uchun namuna kerak? Qisqacha yozing.\n\n<i>Masalan: kosmetika uchun aromatizator, sut mahsuloti uchun stabilizator.</i>",
            ru: "Для какого продукта/отрасли нужен образец? Кратко опишите.\n\n<i>Например: ароматизатор для косметики, стабилизатор для молочной продукции.</i>",
          },
          type: "text",
          required: true,
          options: [],
        ...
        { id: "volume", label: { uz: "Ishlab chiqarish hajmi (ixtiyoriy):", ru: "Объём производства (необязательно):" }, type: "text", required: false, options: [], mapTo: null },
      ],
    },
